<?php
    ...
    $userQuery="SELECT CONCAT(U.Fname,' ',U.Lname) AS 'CURRENTU' FROM users U WHERE User_ID='$activeUser'";
            ...
            <div>
                <div class="d-flex row" style="min-height:175px;">
                            ...
                            <div class="row justify-content-center gap-3 mt-5 no-print">
                                <hr>
                                <input type="submit" class="btn btn-primary save_btn" value="Approve"/>
