<?php
    ...
    if(isset($_POST['btnSubmit']))
    {
        ...
        if($chk_count==0)
        {
            ...
            $insertQuery1="INSERT INTO vendors(`vendorID`, `vendor`, `address`, `tel`, `fax`, `brNo`, `vatNo`, `vatPercentage`, `contactPerson`, `email`, `status`, `createdBy`)
                         VALUES ('$venid','$Vendorname','$address','$tel','$fax','$brno','$vatno','$vatprecentage','$conPerson','$email','$venStatus','$activeUser')";
                    ...
                    echo "<script>
                        setTimeout(function(){window.location.href = 'home_page.php?activity=vendor';}, 1000);
                    </script>";
                    exit();
        }
        else
